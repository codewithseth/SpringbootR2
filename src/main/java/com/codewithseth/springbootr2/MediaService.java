...
public class MediaService {
    ...
    public String uploadFile(MultipartFile file) {
        ...
        log.info("The original {}", original);
        log.info("The content type {}", contentType);
        ...
        log.info("The file extension {}", ext);
        log.info("The folder {}", folder);

        // 3. Build object key
        String key = String.format("%s/%s-%s", folder, UUID.randomUUID(), original);

        log.info("The object key {}", key);
        ...
        log.info("The Object request {}", req);
